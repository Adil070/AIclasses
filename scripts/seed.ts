...
const courses = [
  { title: "MS Office Suite", description: "Master Word, Excel, PowerPoint & Outlook for professional productivity and office work.", duration: "2 Months", level: "Beginner", imageUrl: "", badge: "Most Popular", order: 0, published: true },
  { title: "Tally Prime & GST", description: "Complete accounting software with GST filing, payroll, inventory and financial reports.", duration: "3 Months", level: "Beginner", imageUrl: "", badge: "High Demand", order: 1, published: true },
  { title: "Graphic Design", description: "Photoshop, CorelDraw & Canva for logos, banners, posters and professional branding.", duration: "3 Months", level: "Beginner", imageUrl: "", badge: "", order: 2, published: true },
  { title: "Web Design", description: "HTML, CSS & responsive design fundamentals. Build stunning websites from scratch.", duration: "4 Months", level: "Intermediate", imageUrl: "", badge: "Trending", order: 3, published: true },
  { title: "Python Programming", description: "Python fundamentals, scripting, automation and an intro to data science concepts.", duration: "4 Months", level: "Beginner", imageUrl: "", badge: "Trending", order: 4, published: true },
  { title: "Computer Basics", description: "From keyboard to internet — complete foundation for absolute beginners of all ages.", duration: "1 Month", level: "Beginner", imageUrl: "", badge: "", order: 5, published: true },
  { title: "DTP & Data Entry", description: "Desktop publishing, fast typing skills and data entry for office and government jobs.", duration: "2 Months", level: "Beginner", imageUrl: "", badge: "", order: 6, published: true },
  { title: "Hardware & Networking", description: "PC assembly, troubleshooting, LAN setup and basic network administration skills.", duration: "3 Months", level: "Intermediate", imageUrl: "", badge: "", order: 7, published: true },
];
