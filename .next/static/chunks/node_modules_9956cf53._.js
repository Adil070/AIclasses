...
function replaceTemplate(template, data) {
    try {
        ...
        while(ptr < template.length){
            ...
            result += template.substring(ptr, start) + (value != null ? String(value) : "<".concat(key, "?>"));
            ptr = end + 1;
        }
        return result;
    } catch (e) {
...
function initializeApp(_options) {
    ...
    if (existingApp) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(options, existingApp.options)) {
        ...
        } else if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(config, existingApp.config)) {
            throw ERROR_FACTORY.create("duplicate-app" /* AppError.DUPLICATE_APP */ , {
                appName: name,
 ...
 */ function registerVersion(libraryKeyOrName, version, variant) {
    ...
    _registerComponent(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$component$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"]("".concat(library, "-version"), ()=>({
            library,
            version
...
__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/storage/dist/index.esm.js [app-client] (ecmascript)"); //# sourceMappingURL=index.esm.js.map
;
}),
...
*/ 
    ...
    function Ka(a, b, c, d, e) {
        ...
        c = Ma(c);
        return a && a[B] ? a.J(b, c, n(d) ? !!d.capture : false, e) : Na(a, b, c, false, d, e);
    }
    ...
    function Kb(a) {
        ...
        for(let f = 0; f < d; f++)a.h.h = true, c += a.h.i.decode(b[f], {
            stream: !(e && f == d - 1)
        });
        b.length = 0;
        a.h.g += c;
    ...
    T.prototype.toString = function() {
        ...
        var c = this.g;
        if (c || b == "file") a.push("//"), (b = this.o) && a.push(qc(b, rc, true), "@"), a.push(L(c).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.u, c != null && a.push(":", String(c));
...
//# sourceMappingURL=node_modules_9956cf53._.js.map